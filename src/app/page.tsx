    ...
    <main>
        ...
        <section aria-labelledby="hero-title" className="relative overflow-hidden bg-anthracite">
          ...
          <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-6 py-24 lg:grid-cols-2 lg:gap-16 lg:px-10 lg:py-36">
            ...
            <div
              className="relative aspect-[4/3] overflow-hidden rounded-2xl border border-white/10 lg:aspect-square"
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 p-8">
                <div className="rounded-xl border border-white/15 bg-white/5 p-5 backdrop-blur-sm">
                  <svg className="h-12 w-12 text-white/40" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" aria-hidden="true">
