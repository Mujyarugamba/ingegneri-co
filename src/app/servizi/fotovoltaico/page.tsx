...
export default function Page() {
  return <ServiceLanding eyebrow="Ingegneria, Edilizia & Energia" title="Fotovoltaico" intro="Studiamo il dimensionamento dell'impianto in relazione ai consumi, alle superfici disponibili, agli impianti esistenti e agli obiettivi del cliente, valutando quando utile anche sistemi di accumulo e strategie di autoconsumo." bullets={["Analisi dei consumi", "Dimensionamento preliminare", "Valutazione delle superfici disponibili", "Accumulo e autoconsumo", "Integrazione con impianti elettrici", "Supporto tecnico alla realizzazione"]} outcomes={["Dimensionare l'impianto sui fabbisogni stimati e sui dati disponibili", "Favorire l'autoconsumo quando tecnicamente ed economicamente utile", "Integrare produzione, accumulo e impianti in modo coerente"]} context={["Quando si vuole valutare un impianto fotovoltaico sulla base dei consumi e delle superfici effettivamente disponibili.","Quando produzione, accumulo, impianto elettrico e nuovi carichi come pompe di calore richiedono una valutazione integrata."]} relatedServices={[{label:"Impianti elettrici",href:"/servizi/impianti-elettrici"},{label:"Efficientamento energetico",href:"/servizi/efficientamento-energetico"},{label:"Impianti termici e climatizzazione",href:"/servizi/impianti-termici-climatizzazione"}]} ecosystemHref="/servizi/ingegneria-edilizia-energia" ecosystemLabel="Ingegneria, Edilizia & Energia" />;
}
