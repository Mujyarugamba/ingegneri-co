...
export default function Page() {
  return <ServiceLanding eyebrow="Ingegneria, Edilizia & Energia" title="Relazione tecnica Legge 10" intro="Predisponiamo, quando richiesta dalla normativa applicabile, la relazione tecnica energetica per interventi su edifici e impianti, coordinando dati dell'involucro, sistemi tecnici e requisiti prestazionali del progetto." bullets={["Nuove costruzioni", "Ristrutturazioni e riqualificazioni nei casi previsti", "Interventi sugli impianti quando soggetti a relazione", "Verifiche dell'involucro", "Verifiche dei sistemi impiantistici", "Coordinamento con progetto e pratica edilizia"]} outcomes={["Documentare i requisiti energetici dell'intervento", "Coordinare involucro e impianti", "Ridurre incongruenze tra progetto edilizio ed energetico"]} context={["Nuove costruzioni e interventi sull'edificio o sugli impianti nei casi in cui la normativa applicabile richiede la relazione tecnica energetica.","Quando il progetto edilizio e quello impiantistico devono essere coordinati con le verifiche delle prestazioni energetiche."]} relatedServices={[{label:"APE e certificazione energetica",href:"/servizi/ape-certificazione-energetica"},{label:"Impianti termici e climatizzazione",href:"/servizi/impianti-termici-climatizzazione"},{label:"Efficientamento energetico",href:"/servizi/efficientamento-energetico"}]} ecosystemHref="/servizi/ingegneria-edilizia-energia" ecosystemLabel="Ingegneria, Edilizia & Energia" />;
}
