...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${siteConfig.url}/servizi/conformita-urbanistica-catastale`, changeFrequency: "monthly", priority: 0.85 },
    { url: `${siteConfig.url}/servizi/ape-certificazione-energetica`, changeFrequency: "monthly", priority: 0.85 },
    ...
    { url: `${siteConfig.url}/servizi/impianti-termici-climatizzazione`, changeFrequency: "monthly", priority: 0.85 },
    { url: `${siteConfig.url}/servizi/direzione-lavori`, changeFrequency: "monthly", priority: 0.85 },
    { url: `${siteConfig.url}/servizi/sicurezza-cantieri`, changeFrequency: "monthly", priority: 0.85 },
    ...
    { url: `${siteConfig.url}/servizi/automazione-industriale`, changeFrequency: "monthly", priority: 0.85 },
